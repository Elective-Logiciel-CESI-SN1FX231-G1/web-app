<template>
  <div>
    <v-container>
      <v-card outlined>
        <v-row>
          <v-col class="col-12 text-center" v-if="user && user.role === 'deliverer'">
                      ...
                      <v-list-item  :key="order._id">
                        <v-list-item-content class="mr-4" >
                          <v-list-item-title>
                            <v-row>
                              <v-col>
                                Le {{ order.deliveringDate }}, pour {{ order.client.firstname }}
                              </v-col>
                              <v-spacer></v-spacer>
          ...
          <v-col class="col-12 text-center" v-else-if="user && user.role === 'client'">
                        ...
                        <v-list-item-content class="mr-4" >
                          <v-list-item-title>
                            <v-row>
                              <v-col class="col-md-8 col-6">
                                <p style="display: block; white-space: pre-line" v-text="order.restaurant.name + ', ' + order.restaurant.address + ', effectuée le ' + order.deliveringDate"></p>
                                <p>Client : <span v-text="order.client.firstname"></span></p>
                              </v-col>
                              <v-spacer></v-spacer>
                              <v-col class="d-flex align-center" style="flex-grow: 0;">
                                {{ order.price }}€
